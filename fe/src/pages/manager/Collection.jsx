...
import {SettingCollection} from "../../services/AllService";
...
export function Collection() {
    const {data, filters, setFilters, paging, update, create, remove, refresh} = useCrudList(SettingCollection);
    ...
    function onAdd() {
        setEditData(null);
        const modalEl = document.getElementById("collection");
